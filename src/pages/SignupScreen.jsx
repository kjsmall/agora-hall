...
export default function SignupScreen({ onSignup, error, notice }) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-950 text-slate-50 px-4">
      <div className="w-full max-w-md bg-slate-900 border border-slate-800 rounded-2xl p-8 shadow-xl shadow-cyan-900/20">
        <p className="text-cyan-200 uppercase text-xs font-semibold mb-2">Create Account</p>
        <h1 className="text-2xl font-semibold mb-4">Join Agora Hall</h1>
        <p className="text-sm text-slate-400 mb-6">
          Structure your dialogue—no algorithms, just intentional exchanges.
        </p>
        ...
        <p className="text-xs text-slate-400 mt-4">
          ...
          <Link to="/login" className="text-cyan-300 hover:text-white">Log in</Link>
        </p>
      </div>
    </div>
  );
